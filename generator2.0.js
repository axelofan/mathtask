generator = {
    ...
    replace: function (l) {
        ...
        while (math.test(l)) l.match(math).forEach((element) => {l = l.replace(new RegExp(/--/g),'+'); console.log(l); l = l.replace(new RegExp(/\+-/g),'-'); l = l.replace(element,this.roundPHP(eval(element),8)); });
